 ...
 const getuser2=async()=>{
  ...
  const getuser=async()=>{
    console.log("Entering in get user")
      await axios({
        method: 'GET',
        url:"http://192.168.209.189:8082/transaction/deposit/Amount:"+amt+"/AccountNo:"+rAcc+"/EnterPin:"+Pin
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollable} style={styles.container1}>
     ...
     <TouchableOpacity style={styles.loginbtn } onPress={getuser2}>
        ...
        <Text style={{alignItems:'center',fontSize:17,color:'black'}}>Deposit</Text>
     </TouchableOpacity>
     </View>
